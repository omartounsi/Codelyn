    ...
    >
      ...
      >
        ...
        <div className="flex items-center mt-10 mb-8 border justify-evenly w-[92%] mx-auto p-6 rounded-2xl bg-neutral-700/30 border-neutral-700 gap-2">
          ...
          <div className="max-w-md">
            <p className="text-xl text-right text-neutral-400 font-[Quicksand] mb-4">
              Learn HTML from the ground up and build your first websites with
              confidence. A guided path to mastering web fundamentals with real
              coding and instant results.
            </p>
            {/* <p className="mb-4 text-base font-light text-neutral-300 sm:text-lg">
              Learn HTML from the ground up and build your first websites with
              confidence. A guided path to mastering web fundamentals with real
              coding and instant results.
            </p> */}
            ...
            <div className="flex flex-wrap justify-end gap-2 text-sm">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 border rounded-full border-neutral-700/40 bg-neutral-800/50">
                ...
                <span className="text-neutral-600">~4 Hours</span>
              </div>

              {/* Learning Objectives Pills */}
              {/* <div className="flex items-center gap-2 px-3 py-1.5 border rounded-full border-neutral-700/40 bg-neutral-800/50">
                <IoCode className="w-4 h-4 text-orange-400" />
                <span className="text-neutral-300">HTML Structure</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 border rounded-full bg-neutral-800/50 border-neutral-200">
                <IoGlobe className="w-4 h-4 text-blue-400" />
                <span className="text-neutral-700">Web Content</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 border rounded-full bg-neutral-100 border-neutral-200">
                <IoLayers className="w-4 h-4 text-green-400" />
                <span className="text-neutral-700">Media & Forms</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 border rounded-full bg-neutral-100 border-neutral-200">
                <IoRocket className="w-4 h-4 text-purple-400" />
        ...
        <div className="relative flex items-stretch justify-center gap-6 ">
          {/* CONNECTING LINE */}
          {/* <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-0.5 bg-gradient-to-r from-orange-500/50 to-red-400/50 z-0"></div>
          <div className="absolute z-10 w-3 h-3 transform -translate-x-1/2 -translate-y-1/2 bg-orange-500 rounded-full shadow-lg top-1/2 left-1/2"></div> */}
          ...
          >
            ...
            <p className="mb-6 leading-relaxed text-md text-neutral-400">
              Progress through each chapter to master HTML fundamentals. Click
              on any chapter to start learning, or use the menu to mark lessons
              as complete.
            </p>
            {/* CHAPTERS */}
          ...
          >
            ...
            {/* NEXT LESSON SECTION */}
            <div className="p-6 mt-6 border bg-gradient-to-r from-orange-500/10 to-red-400/10 rounded-xl border-orange-500/30">
              <h3 className="mb-3 text-2xl font-semibold text-neutral-100">
                Continue Learning
              </h3>
              {(() => {
                const nextLesson = chapters.find(
                  (chapter) => !isLessonCompleted("html", chapter.id)
                );
                if (nextLesson) {
                  return (
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={() =>
                          navigate(`/lessons/html/${nextLesson.id}`)
                        }
                        className="flex items-center justify-center w-10 h-10 text-sm font-medium text-white transition-colors duration-200 bg-orange-500 rounded-full cursor-pointer hover:bg-orange-600"
                      >
            ...
            <div className="p-6 mt-6 border bg-neutral-800/50 rounded-xl border-neutral-700">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                ...
                <div className="flex flex-col items-center p-3 border rounded-full border-orange-500/40 bg-neutral-900/50 ">
